...
unsafe fn add3(_env:JNIEnv, _class:JClass, a:i32, b:i32) -> i32 { a + b }

android_fn![com_example, tao_app, SomeClass, add4, [], i32];
unsafe fn add4(_env:JNIEnv, _class:JClass) -> i32 { 0 }
...
unsafe fn add8(_env:JNIEnv, _class:JClass, _a:i32, _b:i32) -> i32 { 0 }
