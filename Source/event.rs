...
pub struct KeyEvent {
	...
	/// be the W, A, S, and D keys on a US layout. The position of these keys
	/// is more important than their label, so they should map to Z, Q, S, and D
	/// on an "AZERTY" layout. (This value is `KeyCode::KeyW` for the Z key on
	/// an AZERTY layout.)
	///
