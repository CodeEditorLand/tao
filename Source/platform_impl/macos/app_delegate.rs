...
lazy_static! {
	pub static ref APP_DELEGATE_CLASS: AppDelegateClass = unsafe {
		...
		decl.add_method(
			...
			application_open_urls as extern fn(&Object, Sel, id, id),
		);
		decl.add_method(
...
extern fn application_will_terminate(_:&Object, _:Sel, _:id) {
	trace!("Triggered `applicationWillTerminate`");
	AppState::exit();
	trace!("Completed `applicationWillTerminate`");
}

extern fn application_open_urls(_:&Object, _:Sel, _:id, urls:id) -> () {
...
extern fn application_should_handle_reopen(
	_:&Object,
	_:Sel,
	_:id,
