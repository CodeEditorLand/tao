...
struct UnityLib {
	...
	unity_launcher_entry_set_count:unsafe extern fn(entry:*const isize, value:i64) -> i32,
	unity_launcher_entry_set_count_visible:unsafe extern fn(entry:*const isize, value:bool) -> bool,
}
